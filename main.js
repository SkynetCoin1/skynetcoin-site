...
// ===== Config (меняй под себя в одном месте) =====
window.SKY = {
...
const translations = {
  en: {
    hero_title: "The Future of Crypto Meets AI",
    hero_sub: "Welcome to Skynet Coin",
    hero_p: "Skynet Coin ($SKY) merges blockchain and artificial intelligence. Fast, secure, decentralized.",
    about_h2: "About Skynet Coin",
    tokenomics_h2: "Tokenomics",
    roadmap_h2: "Roadmap",
    nftdao_h2: "NFT / DAO / Utility",
    airdrop_h2: "Claim Your Airdrop",
    footer: "Contact: " + window.SKY.CONTACT_EMAIL
  },
  ru: {
    hero_title: "Будущее крипты встречается с ИИ",
    hero_sub: "Добро пожаловать в Skynet Coin",
    hero_p: "Skynet Coin ($SKY) объединяет блокчейн и искусственный интеллект. Быстро, безопасно, децентрализовано.",
    about_h2: "О проекте Skynet Coin",
    tokenomics_h2: "Токеномика",
    roadmap_h2: "Дорожная карта",
    nftdao_h2: "NFT / DAO / Utility",
    airdrop_h2: "Получите Airdrop",
...
// ===== Analytics (GA4, по умолчанию выключено) =====
(function initGA(){
  ...
  window.gtag = gtag;
  gtag('js', new Date());
  gtag('config', window.SKY.GA4_ID, {'anonymize_ip': true});
})();
